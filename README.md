...
-	Папка Aligned_2. Содержит 10000 изображений лиц, выровненных только по глазам (2 точки).
-	Папка Aligned_3. Содержит 10000 изображений лиц, выровненных по глазам и носу (3 точки).
